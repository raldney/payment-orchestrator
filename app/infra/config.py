...
class Settings(BaseSettings):
    ...
    debug: bool = False
    log_level: str = 'INFO'
    log_sensitive_keywords: set[str] = {'tax_id', 'cpf', 'cnpj', 'stark_private_key', 'private_key', 'password', 'secret', 'token', 'digital_signature', 'name', 'email', 'phone', 'account_number', 'branch_code'}
...
settings = Settings()
logging.getLogger("payment-orchestrator").info(f"CONFIG: generate_invoices_enabled={settings.generate_invoices_enabled}")
