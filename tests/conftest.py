...
def make_invoice():
    def _factory(
        invoice_id: str = "00000000-0000-0000-0000-000000000005",
        external_id: str = "ext_stark-001",
        amount: int = 1000,
        tax_id: str = "11.222.333/0001-81",
...
def make_transfer():
    def _factory(
        transfer_id: str = "00000000-0000-0000-0000-000000000006",
        invoice_id: str = "00000000-0000-0000-0000-000000000005",
        external_id: str = "ext_tr-001",
        amount: int = 990,
        fee: int = 10,
